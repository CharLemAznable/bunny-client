...
@ContextConfiguration(classes = BunnyHttpClientDefaultConfiguration.class)
public class BunnyHttpClientDefaultTest {
    ...
    @SneakyThrows
    @Test
    public void testBunnyHttpClient() {
        try (val mockWebServer = new MockWebServer()) {
            ...
            val chargeResponse = bunnyHttpClient.charge(chargeRequest);
            ...
            val advanceResponse = bunnyHttpClient.paymentAdvance(advanceRequest);
            ...
            val commitResponse = bunnyHttpClient.paymentCommit(commitRequest);
            ...
            val rollbackResponse = bunnyHttpClient.paymentRollback(rollbackRequest);
